...
% 16889 trials
tap_exploration('GP1829_001_061_taps_pv_aah.mat',1) %naive partial lesion but seemed to learn IPI kind of (after 5000 trials), and ITI kind of!!

% 16869 trials
tap_exploration('GP1830_001_084_taps_pv_aah.mat',2)% this guy was switched to auditory feedback but before then did not learn ANY structure

% 20321 trials
tap_exploration('GP1831_001_045_taps_pv_aah.mat',3)% this guy systematically undershot IPI, no stereotyped ITI but did learn some low CV for IPI

% 17084 trials
tap_exploration('GP1832_001_070_taps_pv_aah.mat',4) %learned around 13k trials

% 16751 trials
tap_exploration('GP1838_001_099_taps_pv_aah.mat',5)% learned around 5k trials

% 17800 trials
tap_exploration('GP1840_001_059_taps_pv_aah.mat',6)% learned around 5k trials
end
