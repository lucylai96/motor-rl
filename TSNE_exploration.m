...
close all
mode = 'tsne';
binary = 0; %do on binary rewards or not?
...
subplot 335; hold on
[dims,plt,idx]=vis(analysis,5,mode); axis square; % group 5

subplot 336; hold on
[dims,plt,idx]=vis(analysis,6,mode); axis square; % group 6

subplot 337; hold on
[dims,plt,idx]=vis(analysis,7,mode); axis square; % group 7


subplot 338; hold on
[dims,plt,idx]=vis(analysis,8,mode); axis square; % group 8
%prettyplot
...
% 
% subplot 132
% imagesc(log(RRR));set(gca,'YDir','normal');
% xlabel('tap(t+1)')
% ylabel('tap(t)')
% axis square
...
% 
% %% raw counts
% figure;subplot 131; imagesc(T);axis square;set(gca,'ydir','normal')
% subplot 132;imagesc(R); colormap(gca,flipud(hot));axis square;set(gca,'ydir','normal')
% subplot 133;scatter(reshape(T,[1 N^(a*2)]),reshape(R,[1 N^(a*2)]));axis square;
% 
% set(gcf,'Position',[100 300 900 270]);
% 
